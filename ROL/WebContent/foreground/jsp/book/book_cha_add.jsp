...
<jsp:include page="../common/top.jsp">
	<jsp:param value="添加章节" name="title"/>
</jsp:include>
...
<body>
	<c:choose>
		<c:when test="${empty param.bookId  || USER.permission == '10'}">
				<script>
...
<div>
	<h2 style="text-align: center;">添加章节</h2>
	<form action="${ctx }/foreground/jsp/book/book_addBookCha" method="post" style="width:1024px;margin-left:auto;margin-right:auto;margin-top:30px">
