...
import com.oneflyingleaf.constant.SessionEnum;
...
public class LogUtils {
	...
	private static void saveLog(String logCode,String logDes,String logIp,String logType,String userId){
		com.oneflyingleaf.ho.data.Log l = new com.oneflyingleaf.ho.data.Log(null,logCode,logDes,logIp,new Timestamp(System.currentTimeMillis()),logType,userId);
